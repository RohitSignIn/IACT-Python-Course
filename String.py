...
b = "Hello, World!"
print(b[-5:-2]) #Negative Index to start Slicing from the end

#Note print(b[-11:-5]) #error, can't do like this it should be print(b[-11:-5])
...
a = "Hello, World!"
print(a.split(",")) # returns ['Hello', ' World!'], convert to list
